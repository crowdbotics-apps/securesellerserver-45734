"""
Django settings for securesellerserver_45734 project.
...
ROOT_URLCONF = 'securesellerserver_45734.urls'
...
WSGI_APPLICATION = 'securesellerserver_45734.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "securesellerserver_45734 API",
    "DESCRIPTION": "API documentation for securesellerserver_45734 App",
    "VERSION": "v1",
}
